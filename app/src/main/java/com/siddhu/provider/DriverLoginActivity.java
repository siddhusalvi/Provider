...
public class DriverLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() == null) {
            ...
            startActivity(new Intent(DriverLoginActivity.this, MandatoryDetailsActivity.class));
            finish();
        } else {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            editor.putString(DRIVER_PHONE_NUMBER,phoneNumber);
                            editor.commit();
                            String msg = "Sign in Successful :)";
                            showMsg(msg);
                            startActivity(new Intent(DriverLoginActivity.this,MandatoryDetailsActivity.class).putExtra("phone",phoneNumber));
                            finish();
                        } else {
